...
plugin_identifier = "ssd1306_oled_display"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_ssd1306oleddisplay"
...
plugin_version = "0.1.2rc0"

# The plugin's description. Can be overwritten within OctoPrint's internal data via __plugin_description__ in the plugin
# module
plugin_description = """Octoprint plugin to display information on a SSD1306-based OLED display connected through I2C."""
